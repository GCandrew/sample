  ...
  export default {
    ...
    methods: {
      zoomImage(e) {
        ...
        this.overlayStyle.left = `${e.clientX - left - 50}px`; // Adjust the offset for centering
        this.overlayStyle.top = `${e.clientY - top - 50}px`;  // Adjust the offset for centering
        this.overlayStyle.width = "100px"; // Size of the zoom overlay
        this.overlayStyle.height = "100px"; // Size of the zoom overlay
      },
      resetZoom() {
