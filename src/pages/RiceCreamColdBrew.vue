<template>
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">막걸리향 크림 콜드 브루</li>
    </ol>
  </nav>
  </div>
  ...
  <div class="col-md-6 info-section">
    <h2>막걸리향 크림 콜드 브루</h2>
    <p class="text-muted">Rice Cream Cold Brew</p>
    <hr class="m-hr"/>
    <p>
        산에서 만날 수 있는 특별한 경험을 모티브로해 달콤, 향긋한 비알코올 막걸리 향 크림과 고소한 쌀 토핑으로 즐길 수 있는 콜드 브루
    </p>
    <hr />
  ...
  export default {
    data() {
      return {
        imageSrc:
          "https://image.istarbucks.co.kr/upload/store/skuimg/2024/05/[9200000005282]_20240509131200287.jpg",
        thumbnails: [
          // 썸네일 이미지 URL 추가
          "https://image.istarbucks.co.kr/upload/store/skuimg/2024/05/[9200000005282]_20240509131200287.jpg",
          // 다른 썸네일 이미지 링크
