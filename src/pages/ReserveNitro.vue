<template>
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">리저브 나이트로</li>
    </ol>
  </nav>
  </div>
  ...
  <div class="col-md-6 info-section">
    <h2>리저브 나이트로</h2>
    <p class="text-muted">Reserve Nitro</p>
    <hr class="m-hr"/>
    <p>
        나이트로 커피 정통의 캐스케이딩과 부드러운 콜드 크레마! <br>
    ...
    <div class="desc">
    <p>
        차가운 물로 서서히 완성된 콜드 브루가 질소와 만나 <br>
나이트로 커피 정통의 캐스케이딩과 부드러운 콜드 크레마를 탄생시켰습니다.<br>

부드러운 목넘김과 완벽한 밸런스에 커피 본연의 단맛을 경험할 수 있습니다.<br>

격조 있는 커피가 어울리는 당신께 스타벅스가 지금, 제안합니다.<br>
    </p>
  </div>
  </template>
  ...
  export default {
    data() {
      return {
        imageSrc:
          "https://image.istarbucks.co.kr/upload/store/skuimg/2021/02/[9200000002407]_20210225095106747.jpg",
        thumbnails: [
          // 썸네일 이미지 URL 추가
          "https://image.istarbucks.co.kr/upload/store/skuimg/2021/02/[9200000002407]_20210225095106747.jpg",
          // 다른 썸네일 이미지 링크
