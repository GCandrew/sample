<template>
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">돌체 콜드 브루</li>
    </ol>
  </nav>
  </div>
  ...
  <div class="col-md-6 info-section">
    <h2>돌체 콜드 브루</h2>
    <p class="text-muted">Dolce Cold Brew</p>
    <hr class="m-hr"/>
    <p>
        무더운 여름철,<br>
    ...
    <div class="desc">
    <p>
        무더운 여름철, 동남아 휴가지에서 즐기는 커피를 떠오르게 하는 스타벅스 음료의 베스트조합인 돌체 콜드 브루를 만나보세요!
    </p>
  </div>
  </template>
