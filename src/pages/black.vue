<template>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">흑임자 크림 콜드 브루</li>
  </ol>
</nav>
</div>
...
<div class="col-md-6 info-section">
  <h2>흑임자 크림 콜드 브루</h2>
  <p class="text-muted">Black Sesame Cream Cold Brew</p>
  <hr />
  <p>
    <strong>[제주 Only]</strong> 흑임자 크림의 고소함에<br />
    콜드 브루의 깔끔함을 더해<br />
    제주 돌담길의 정겨움을 표현한 음료
  </p>
  <hr />
...
export default {
  data() {
    return {
      imageSrc:
        "https://image.istarbucks.co.kr/upload/store/skuimg/2024/07/[9200000005378]_20240701133238611.jpg",
      thumbnails: [
        // 썸네일 이미지 URL 추가
        "https://image.istarbucks.co.kr/upload/store/skuimg/2024/07/[9200000005378]_20240701133238611.jpg",
        // 다른 썸네일 이미지 링크
